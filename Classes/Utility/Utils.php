...
class Utils implements SingletonInterface
{
     ...
     */
    public function getTemplateSubpart(string $templateFile, string $templatePart, array $markerArray = []): string
    {
        ...
        if (!$template) {
            throw new \Exception('Could not load file ' . $templateFile);
        }
        ...
        return $templateService->substituteMarkerArray($template, $markerArray, '###|###', true);
    }
